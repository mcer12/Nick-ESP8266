...
void handleRoot() {
  ...
  */
  ...
  html += "<div class=\"github\"> <p>NICK IN-12 duplexed FW ";
  html += FW_VERSION;
  html += ", check out <a href=\"https://github.com/mcer12/Nick-ESP8266\" target=\"_blank\"><strong>NICK</strong> on GitHub</a></p> </div>";
  html += "</div>";
