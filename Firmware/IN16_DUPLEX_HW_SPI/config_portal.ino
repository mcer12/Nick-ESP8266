...
static const char html_header[] PROGMEM =
  ...
  "<title>NICK - Wi-Fi Nixie Clock</title>"
  "<style>"
  "html,body{margin:0;padding:0;font-size:16px;background:#230e03;}"
  ...
  ".container{margin:auto;padding:40px;max-width:600px;color:#fff;background:#000;box-shadow:0 0 100px rgb(247,134,77,.5);border: 3px solid #f7864d;border-radius:20px;}"
  ...
  "h2{color:#f7864d;margin:30px 0 0 0;font-family:Arial,sans-serif;font-weight:300;font-size:1.5rem;}"
  ...
  "input[type=\"text\"]:hover,input[type=\"number\"]:hover,input[type=\"password\"]:hover,select:hover{border-color:#9f7864;}"
  "input[type=\"text\"]:focus,input[type=\"password\"]:focus,select:focus{border-color:#f7864d;}"
  "option{color:#000;}"
  "button{display:block;width:100%;padding: 15px 20px; margin-top: 40px;font-size:1rem;font-weight:700;text-transform:uppercase;background:#f7864d;border:0;border-radius:5px;cursor:pointer;transition:.15s;outline:none;}"
  "button:hover{background:#ffb18a;}"
  ".github{padding:15px;text-align:center;}.github a{color:#f7864d;transition:.15s;}"
  ".github a:hover{color:#ffb18a;}"
  ".github p{margin:0;}"
...
static const char html_wrapper_end[] PROGMEM =
  ...
  "<div class=\"github\"><p>"
  "{{fw_name}} {{fw_version}}"
  ", check out <a href=\"https://github.com/mcer12/Flora-ESP8266\" target=\"_blank\"><strong>NICK</strong> on GitHub</a></p> </div>"
  "</div>";
...
void handleRoot() {
  ...
  if (!server.args() || (server.args() && server.hasArg("is_form"))) {
    ...
    html += "<h1>NICK - Wi-Fi Nixie Clock</h1> <p></p>";
